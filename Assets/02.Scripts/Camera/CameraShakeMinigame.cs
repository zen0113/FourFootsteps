...
public class CameraShakeMinigame : MonoBehaviour
{
    ...
    void OnDisable()
    {
        // Debug.Log("[CameraShake] OnDisable 호출됨. 쉐이크를 강제 중지하고 오프셋을 0으로 초기화합니다.");

        // StopShake() 함수가 코루틴을 중지하고 
        // shakeOffset을 Vector3.zero로 설정해줍니다.
        StopShake();
    }
