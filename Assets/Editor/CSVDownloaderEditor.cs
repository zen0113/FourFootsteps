...
public class CSVDownloaderEditor : EditorWindow
{
    ...
    public static void DownloadCSVs()
    {
        ...
        {
            string url = $"https://docs.google.com/spreadsheets/d/1TP4lKuDZTtIc_fa2CLNgrcCdTwEaysrJVnCq18QuKeQ/export?format=csv&id=1TP4lKuDZTtIc_fa2CLNgrcCdTwEaysrJVnCq18QuKeQ&gid={sheet.Value}";
