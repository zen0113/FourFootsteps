...
public class ResponsibilityManager : MonoBehaviour
{
    ...
    // 책임감 게이지 
    [SerializeField] private GameObject responsibilityGauge;
    ...
    void Start()
    {
        responsibilityGauge = GameObject.Find("ResponsibilityGauge");
        responsibilitySlider = GameObject.Find("ResponsibilitySlider").GetComponent<Slider>();
    }
